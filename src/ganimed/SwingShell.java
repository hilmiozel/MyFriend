...
public class SwingShell
{
	...
	class EnterSomethingDialog extends JDialog
	{
		...
		public EnterSomethingDialog(JFrame parent, String title, String content, boolean isPassword)
		{
			this(parent, title, new String[] { content }, isPassword);
                ...
                public EnterSomethingDialog(String answer,boolean isPassword)
                {
                    this.answer=answer;
	...
	class TerminalDialog extends JDialog
	{
		...
		public TerminalDialog(JFrame parent, String title, Session sess, int x, int y) throws IOException
		{
			...
			botPanel.add(logoffButton);
                        logoffButton2 = new JButton("ls");
			botPanel.add(logoffButton2);
			...
			logoffButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					dispose();
                        ...
                        logoffButton2.addActionListener(new ActionListener() {
                            
                            public void actionPerformed(ActionEvent e) {
                                try {
                                    out.write("ls -altr | more \n".getBytes());
                                } catch (IOException ex) {
                                    Logger.getLogger(SwingShell.class.getName()).log(Level.SEVERE, null, ex);
                                }
                            }
                        });
				...
				while (true)
				{
					...
					if (conn.isAuthMethodAvailable(username, "password"))
					{
						...
						//		new String[] { lastError, "Enter password for " + username }, true);
                                                final EnterSomethingDialog esd = new EnterSomethingDialog(password,true);
						esd.setVisible(true);
	...
	void loginPressed()
	{
        ...
        public void osConnect(String hostname,String username,String password)
	{
	...
	void showGUI()
	{
		...
		hostField = new JTextField("", 20);
                hostField.setText("192.168.126.136");
		userField = new JTextField("", 10);
                userField.setText("rasit");
